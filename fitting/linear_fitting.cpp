...
namespace cliz
{
	...
	{
		//printf("In linear_fitting_dpd, pos=%lld, posl=%lld, datal=%f, posr=%lld, datar=%f\n",i,i-stride,data[i-stride],i+stride,data[i+stride]);
	...
	{
		//printf("In linear_fitting_dp, pos=%lld, posl=%lld, datal=%f\n",i,i-stride,data[i-stride]);
	...
	{
		//printf("In linear_fitting_ddp, pos=%lld, posl=%lld, datal=%f, posr=%lld, datar=%f\n",i,i-3*stride,data[i-3*stride],i-stride,data[i-stride]);
