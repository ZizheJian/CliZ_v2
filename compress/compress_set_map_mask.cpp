#ifndef __COMPRESS_SET_MAP_MASK_CPP__
#define __COMPRESS_SET_MAP_MASK_CPP__
...
{
	template<typename T>
	void task_c<T>::compress_set_map_mask()
	{
		...
		call_DC_functions_data_set_map_mask();
		...
		map_bitstream_end=ZSTD_compress(map_bitstream,it2->mx[latid]*it2->mx[lngid],temp_map_bitstream,map_bitstream_end,3);
