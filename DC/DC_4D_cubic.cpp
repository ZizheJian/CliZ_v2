#ifndef __DC_4D_CUBIC_CPP__
#define __DC_4D_CUBIC_CPP__
...
namespace cliz
{
	...
	void task_c<T>::DC_4D_cubic()
	{
		...
		// 										else
		// 											if (i3+5*stride<=b3e)
		// 												pred=cubic_fitting_dddpd(pos+i3*weight[3],-stride*weight[3]);
		// 											else
		...
		// 										else
		// 											if (i3-7*stride>=b3b)
		// 												pred=cubic_fitting_ddddp(pos+i3*weight[3],stride*weight[3]);
		// 											else
		// 												if (i3-5*stride>=b3b)
