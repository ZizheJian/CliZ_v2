#ifndef __DC_2D_LINEAR_DATA_USE_MAP_MASK_CPP__
#define __DC_2D_LINEAR_DATA_USE_MAP_MASK_CPP__
...
{
	template<typename T>
	void task_c<T>::DC_2D_linear_data_use_map_mask()
	{
		...
		if (mask_data[pos2horiz_mapping[0]]!=0)
		{
				...
				printf("Error: DC_2D_linear_data_use_map_mask shouldn't be called during decompression.\n");
				exit(0);
			#endif
			quant_bin_pos++;
		}
