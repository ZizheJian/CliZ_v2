for dimension_num in [1,2,3,4]:
	file=open(f"transpose_data_{dimension_num}D.cpp","w")
	file.write(f"#ifndef __TRANSPOSE_DATA_{dimension_num}D_CPP__\n")
	file.write(f"#define __TRANSPOSE_DATA_{dimension_num}D_CPP__\n")
	file.write("\n")
	...
	file.write(f"	void task_c<T>::transpose_data_{dimension_num}D(T *data_backup)\n")
	file.write("	{\n")
...
for dimension_num in [1,2,3,4]:
	file=open(f"transpose_map_{dimension_num}D.cpp","w")
	file.write(f"#ifndef __TRANSPOSE_MAP_{dimension_num}D_CPP__\n")
	file.write(f"#define __TRANSPOSE_MAP_{dimension_num}D_CPP__\n")
	file.write("\n")
	file.write("#include \"transform.hpp2\"\n")
	file.write("\n")
	file.write("namespace cliz\n")
	file.write("{\n")
	file.write("	template<typename T>\n")
	file.write(f"	void task_c<T>::transpose_map_{dimension_num}D(long long *pos2horiz_mapping_backup)\n")
	file.write("	{\n")
	file.write("		int *dim_seq=best_it1->dim_seq;\n")
	file.write("		long long *mx2=it2->mx;\n")
	file.write("		long long *weight2=it2->weight;\n")
...
for dimension_num in [1,2,3,4]:
	file=open(f"transpose_data_and_map_{dimension_num}D.cpp","w")
	file.write(f"#ifndef __TRANSPOSE_DATA_AND_MAP_{dimension_num}D_CPP__\n")
	file.write(f"#define __TRANSPOSE_DATA_AND_MAP_{dimension_num}D_CPP__\n")
	file.write("\n")
	file.write("#include \"transform.hpp2\"\n")
	file.write("\n")
	file.write("namespace cliz\n")
	file.write("{\n")
	file.write("	template<typename T>\n")
	file.write(f"	void task_c<T>::transpose_data_and_map_{dimension_num}D(T *data_backup,long long *pos2horiz_mapping_backup)\n")
	file.write("	{\n")
	file.write("		int *dim_seq=best_it1->dim_seq;\n")
	file.write("		long long *mx2=it2->mx;\n")
	file.write("		long long *weight2=it2->weight;\n")
