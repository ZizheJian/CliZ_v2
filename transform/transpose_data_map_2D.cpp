#ifndef __TRANSPOSE_DATA_MAP_2D_CPP__
#define __TRANSPOSE_DATA_MAP_2D_CPP__
...
{
	template<typename T>
	void task_c<T>::transpose_data_map_2D(T *data_backup,long long *pos2horiz_mapping_backup)
	{
