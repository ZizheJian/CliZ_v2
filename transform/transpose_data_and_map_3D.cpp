#ifndef __TRANSPOSE_DATA_AND_MAP_3D_CPP__
#define __TRANSPOSE_DATA_AND_MAP_3D_CPP__
...
{
	template<typename T>
	void task_c<T>::transpose_data_and_map_3D(T *data_backup,long long *pos2horiz_mapping_backup)
	{
		...
		for (i[0]=0;i[0]<mx1[0];i[0]++)
		{
			...
			for (i[1]=0;i[1]<mx1[1];i[1]++)
			{
				...
				{
					j[dim_seq[2]]=i[2];
					long long pos1=i[0]*weight1[0]+i[1]*weight1[1]+i[2]*weight1[2];
					long long pos2=j[0]*weight2[0]+j[1]*weight2[1]+j[2]*weight2[2];
